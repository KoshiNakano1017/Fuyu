...
>
> `0041_check_in_changes.sql` がビューを差し替え、内部ビュー `public.v_check_in_nights` が返す
...
**`v_check_in_nights`**（`0041`）がその夜の形態・人数を返す。優先順は
