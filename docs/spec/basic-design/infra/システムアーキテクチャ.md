...
| 5 | **★ネットワーク層の防御（WAF／FW）はこの図に存在しない**。省略ではなく実際に無い。詳細は本書「ネットワーク層の防御」節 | 2026-09-03 オーナー指摘・非機能 F-9 |
...
### ネットワーク層の防御（2026-09-03 新設 ／ 非機能 F-9・★未決）

> [!warning] 本構成に**ネットワーク層の防御（WAF／ファイアウォール）は存在しない**
